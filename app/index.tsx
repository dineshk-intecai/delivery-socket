...
export default function App() {
    ...
    useEffect(() => {
        ...
        const liveLocationPartnerId = NativeSocketConnection.addListener(
            'live_location_partnerId',
            (data) => {
        ...
        <View style={styles.container}>
            ...
            {isEnabled && (
                <Text style={{ textAlign: 'center' }}>
                    Service is running for partner{`\n${userId}`}
                </Text>
            )}
            {location && (
                <Text>
            ...
            <TouchableOpacity
                ...
                style={[styles.button, { backgroundColor: isEnabled ? 'red' : 'green' }]}>
                <Text style={styles.text}>{isEnabled ? 'Stop' : 'Start'} Service</Text>
            </TouchableOpacity>
        </View>
    );
}
